...
class Little_tool(QWidget):
    ...
    def window2_UI(self, frame):
        ...
        self.ser_sendhex = QtWidgets.QCheckBox(custom_frame)
        ...
        self.send_with_enter = QtWidgets.QCheckBox(custom_frame)
        ...
        self.sendtmr = QTimer(custom_frame)
        self.sendtmr.timeout.connect(self.ser_senddata)

        self.recvtmr = QTimer(custom_frame)
        self.recvtmr.timeout.connect(self.ser_recv)

        self.sendfile_tmr = QTimer(custom_frame)
